...
import com.example.aymen.projet.Analyse;
import com.example.aymen.projet.R;
import com.example.aymen.projet.lesionDetector;
...
public class Camira extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener,View.OnTouchListener{
    ...
    private com.example.aymen.projet.lesionDetector lesionDetector;
        ...
        public void onManagerConnected(int paramInt)
        {
            switch (paramInt)
            {
                case LoaderCallbackInterface.SUCCESS: {
                    ...
                    mOpenCvCameraView.setOnTouchListener(Camira.this);
                    break;
                }
                default: {
